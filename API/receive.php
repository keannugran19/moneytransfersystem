...
<body>
    ...
    <div class="container">
        ...
        <!-- Start of Form -->
        <form action="receiveProcess.php" method="post">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group mb-2">
                            <input class="form-control rounded shadow bg-body rounded" type="text" name="sfirstname" id="firstname" placeholder="First Name" method="post" required>
                        </div>
                        <div class="input-group mb-2">
                            <input class="form-control rounded shadow bg-body rounded" type="text" name="slastname" id="lastname" placeholder="Last Name" method="post" required>
                        </div>
                        <div class="input-group mb-2">
                            <input class="form-control rounded shadow bg-body rounded" type="tel" name="sphonenumber" id="phonenumber" placeholder="Phone Number" method="post" required>
                        </div>
                        <div class="input-group mb-2">
                            <input class="form-control rounded shadow bg-body rounded" type="text" name="saddress" id="address" placeholder="Address" method="post" required>
                        </div>
                    </div>
                </div>
                <div class="row">
