                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li class="m-2"><span><?php echo $_SESSION['email']; ?></span></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 mt-4">
                    <h1 class="text-start">
                        <img src="/moneytransfersystem/img/mt-logo.png" alt="Logo" width="60" height="40" class="d-inline-block align-text-top">
                    ...
                    <h5 class="text-center mx-auto mt-5">Welcome! <span><?php echo $_SESSION['email']; ?></span></h5>
                </div>
                ...
                <div class="col-6">
                    ...
                    <div class="card border-0 bg-transparent position-relative">
                        <div class="row g-0">
                            <div class="col-md-2">
                                <img src="/moneytransfersystem/img/send-logo.png" class="img-fluid rounded-start m-2" width="100" height="100" alt="send">
                            </div>
                            <div class="col-md-5">
                                <div class="card-body">
                                    <br>
                    ...
                    <div class="card border-0 bg-transparent position-relative">
                        <div class="row g-0">
                            <div class="col-md-2">
                                <img src="/moneytransfersystem/img/receive-logo.png" class="img-fluid rounded-start m-2" width="100" height="100" alt="send">
                            </div>
                            <div class="col-md-5">
                                <div class="card-body">
                                    <br>
                    ...
                    <div class="card border-0 bg-transparent position-relative">
                        <div class="row g-0">
                            <div class="col-md-2">
                                <img src="/moneytransfersystem/img/transaction-logo.png" class="img-fluid rounded-start m-2" width="100" height="100" alt="send">
                            </div>
                            <div class="col-md-5">
                                <div class="card-body">
                                    <br>
